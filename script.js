...
// Replaces the legacy corrupted emoji payload with a broad, valid picker set.
CHAT_EMOJIS.splice(0, CHAT_EMOJIS.length,
  ...
  "\u{1F618}", "\u{1F617}", "\u{1F61C}", "\u{1F92A}", "\u{1F61D}", "\u{1F911}", "\u{1F917}", "\u{1F92D}",
  "\u{1F914}", "\u{1F910}", "\u{1F928}", "\u{1F610}", "\u{1F611}", "\u{1F636}", "\u{1F644}", "\u{1F62C}",
  "\u{1F60F}", "\u{1F612}", "\u{1F614}", "\u{1F62A}", "\u{1F634}", "\u{1F924}", "\u{1F60E}", "\u{1F913}",
  "\u{1F973}", "\u{1F979}", "\u{1F62E}", "\u{1F62F}", "\u{1F632}", "\u{1F631}", "\u{1F628}", "\u{1F633}",
  "\u{1F622}", "\u{1F62D}", "\u{1F625}", "\u{1F613}", "\u{1F629}", "\u{1F62B}", "\u{1F624}", "\u{1F621}",
  "\u{1F44B}", "\u{1F91A}", "\u{1F590}", "\u{270B}", "\u{1F596}", "\u{1F44C}", "\u{1F90C}", "\u{1F90F}",
  "\u{270C}", "\u{1F91E}", "\u{1F91F}", "\u{1F918}", "\u{1F919}", "\u{1F448}", "\u{1F449}", "\u{1F446}",
  "\u{1F447}", "\u{261D}", "\u{1F44D}", "\u{1F44E}", "\u{270A}", "\u{1F44A}", "\u{1F44F}", "\u{1F64C}",
  "\u{1F450}", "\u{1F932}", "\u{1F91D}", "\u{1F64F}", "\u{1F4AA}", "\u{1FAF6}", "\u{270D}", "\u{1F485}",
  ...
  "\u{1F498}", "\u{1F49D}", "\u{1F49F}", "\u{1F4A4}", "\u{1F4A2}", "\u{1F4A5}", "\u{1F4AB}", "\u{1F4A6}",
  "\u{1F4A1}", "\u{1F4AF}", "\u{1F525}", "\u{1F31F}", "\u{2728}", "\u{1F389}", "\u{1F38A}", "\u{1F381}",
  "\u{1F3AF}", "\u{1F3C6}", "\u{1F947}", "\u{1F948}", "\u{1F949}", "\u{1F680}", "\u{26A1}", "\u{2705}",
  "\u{274C}", "\u{26A0}", "\u{2757}", "\u{2753}", "\u{1F4CC}", "\u{1F4E2}", "\u{1F4AC}", "\u{1F440}",
  "\u{1F512}", "\u{1F513}", "\u{1F50D}", "\u{1F514}", "\u{1F515}", "\u{1F6A8}", "\u{1F6AB}", "\u{267B}",
  "\u{1F4E6}", "\u{1F4C5}", "\u{1F4C4}", "\u{1F4CE}", "\u{1F4DD}", "\u{1F4BC}", "\u{1F4CA}", "\u{1F4C8}",
  "\u{1F4C9}", "\u{1F4CB}", "\u{1F4D1}", "\u{1F4D6}", "\u{1F4E7}", "\u{1F4E5}", "\u{1F4E4}", "\u{1F4F1}",
  "\u{1F4BB}", "\u{1F5A5}", "\u{1F5A8}", "\u{2328}", "\u{1F527}", "\u{1F528}", "\u{2699}", "\u{1F9F0}",
  "\u{2615}", "\u{1F37D}", "\u{1F355}", "\u{1F354}", "\u{1F35F}", "\u{1F370}", "\u{1F36B}", "\u{1F34E}",
  "\u{1F34C}", "\u{1F349}", "\u{1F36A}", "\u{1F36D}", "\u{1F964}", "\u{1F37A}", "\u{1F377}", "\u{1F942}",
  "\u{1F31E}", "\u{1F319}", "\u{2601}", "\u{26C5}", "\u{1F327}", "\u{26C8}", "\u{1F308}", "\u{1F30A}"
);

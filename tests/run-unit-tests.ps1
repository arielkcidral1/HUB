...
Assert-MatchText $index 'calendar-event-legend[\s\S]*Evento[\s\S]*Anivers.rio[\s\S]*Anivers.rio de empresa[\s\S]*Entrevista[\s\S]*calendar-event-legend[\s\S]*Evento[\s\S]*Anivers.rio[\s\S]*Anivers.rio de empresa[\s\S]*Entrevista' "painel e calendario exibem indice de tipos de evento"
Assert-MatchText $script 'function getEventIcon\(item = \{\}\)[\s\S]*event-icon-company[\s\S]*event-icon-birthday[\s\S]*event-icon-interview[\s\S]*event-icon-default[\s\S]*calendar-event-heading[\s\S]*eventIcon\.icon[\s\S]*calendar-event-modal-title' "cards e modal de evento exibem icones por tipo"
Assert-MatchText $style '\.calendar-event-legend[\s\S]*\.event-icon-birthday[\s\S]*\.event-icon-company[\s\S]*\.event-icon-interview' "icones e indice de eventos possuem estilos dedicados"

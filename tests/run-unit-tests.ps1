...
function Test-LoginHtml {
  ...
  Assert-MatchText $text 'hub-postgres-client\.js\?v=db-load-v2[\s\S]*login-submit\.js\?v=login-submit-v3[\s\S]*script\.js\?v=db-bootstrap-v50' "login possui controlador de autenticacao antes do script principal"
}

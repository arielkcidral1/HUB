...
function Test-ClientSecurityFunctions {
  ...
  Assert-MatchText $recordsApi 'effectiveFilters = !isAuthenticated && table === "hub_vagas"[\s\S]*status", op: "eq", value: "Aberta"' "visitante sem sessao so ve vagas com status Aberta"

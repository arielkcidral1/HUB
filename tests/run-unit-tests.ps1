...
function Test-LoginHtml {
  ...
  Assert-MatchText $text 'hub-postgres-client\.js\?v=db-load-v3[\s\S]*login-submit\.js\?v=no-password-save-v5[\s\S]*script\.js\?v=wait-for-dashboard-data-v84' "login possui controlador de autenticacao antes do script principal"
}
...
function Test-ClientSecurityFunctions {
  ...
  Assert-MatchText $index 'auth-entry\.js\?v=auth-entry-model-v22[\s\S]*style\.css\?v=visible-auth-loading-v23[\s\S]*hub-postgres-client\.js\?v=db-load-v3[\s\S]*assets/company-birthdays\.js\?v=2026-08-05[\s\S]*script\.js\?v=wait-for-dashboard-data-v84[\s\S]*auth-display-guard\.js\?v=preserve-session-v8' "HUB autentica sem exibir o painel antes da validacao"

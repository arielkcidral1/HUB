...
function Test-ClientSecurityFunctions {
  ...
  Assert-MatchText (Read-ProjectFile "auth-entry.js") 'fetch\("/api/auth"[\s\S]*credentials: "same-origin"[\s\S]*action: "session"[\s\S]*persistAuthenticatedSession\([\s\S]*window\.__hubAuthEntryPromise' "entrada reautentica sessao no banco antes de liberar o index"

...
function Test-ClientSecurityFunctions {
  ...
  Assert-MatchText $script 'function getAllEvents\(\)[\s\S]*const eventos = \(data\.eventos \|\| \[\]\)\.filter\(\(item\) => canCurrentUserAccessEventRecord\(item\)\)' "agenda aplica o filtro de acesso por gerente antes de listar os eventos"
